      ...
      <div className="max-w-4xl mx-auto text-center" ref={ref}>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <a href="mailto:cherazen.ai@gmail.com" className="inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-card border border-border text-sm text-foreground font-sans hover:shadow-lg transition-all duration-300">
              <Mail className="w-4 h-4 text-primary" />
              cherazen.ai@gmail.com
            </a>
            <a href="mailto:apeironailabs@gmail.com" className="inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-card border border-border text-sm text-foreground font-sans hover:shadow-lg transition-all duration-300">
