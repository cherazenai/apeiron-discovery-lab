        ...
        <div ref={ref} className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-5 text-base text-muted-foreground font-sans leading-relaxed">
              ...
              <p className="text-foreground/80 italic">Although Cherazen is currently in its early stage, the mission is ambitious: to build foundational AI infrastructure for the future of science.</p>
            </div>
          </motion.div>
        </div>
      </div>
